    ...
    return _then(_value.copyWith(
      ...
      withTimes: null == withTimes
          ...
          : withTimes // ignore: cast_nullable_to_non_nullable
              as bool,
      publicListId: freezed == publicListId
          ? _value.publicListId
...
class _$_ListOfThings implements _ListOfThings {
  const _$_ListOfThings(
      ...
      final Map<String, bool> viewers = const <UserId, bool>{},
      final Map<String, bool> editors = const <UserId, bool>{},
      this.shared = false,
      this.isViewer = false,
      this.isEditor = false})
      : _viewers = viewers,
  ...
  Map<String, bool> get viewers {
    if (_viewers is EqualUnmodifiableMapView) return _viewers;
  ...
  Map<String, bool> get editors {
    if (_editors is EqualUnmodifiableMapView) return _editors;
    // ignore: implicit_dynamic_type
  ...
  @override
  String toString() {
    return 'ListOfThings(id: $id, name: $name, type: $type, userId: $userId, withMap: $withMap, withDates: $withDates, withTimes: $withTimes, publicListId: $publicListId, shareCodeForViewer: $shareCodeForViewer, shareCodeForEditor: $shareCodeForEditor, viewers: $viewers, editors: $editors, shared: $shared, isViewer: $isViewer, isEditor: $isEditor)';
  }
...
abstract class _ListOfThings implements ListOfThings {
  const factory _ListOfThings(
      ...
      final String? shareCodeForViewer,
      final String? shareCodeForEditor,
      final Map<String, bool> viewers,
      final Map<String, bool> editors,
      final bool shared,
      final bool isViewer,
      final bool isEditor}) = _$_ListOfThings;
