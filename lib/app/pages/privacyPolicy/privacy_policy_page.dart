...
const h1style = TextStyle(fontSize: 18, fontWeight: FontWeight.bold);
...
class PrivacyPolicyPage extends StatelessWidget {
  ...
  List<TextSpan> getTexts() {
    return <TextSpan>[
      const TextSpan(
        text: 'Privacy Policy for ListAnything\n\n',
        style: h1style,
      ),
      const TextSpan(
        text: '''
...
* Application refers to ListAnything, the software program provided by the Company.

* Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ListAnything.
